...
class UtilsAsync {
    ...
    static class LatestAppVersion extends AsyncTask<Void, Void, Update> {
        ...
        public LatestAppVersion(Context context, boolean fromUtils, UpdateFrom updateFrom, GitHub gitHub, String xmlOrJsonUrl, IAppUpdater.LibraryListener appUpdater) {
